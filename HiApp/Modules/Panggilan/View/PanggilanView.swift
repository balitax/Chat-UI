...
class PanggilanView: HiBase, UISearchControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(PanggilanListTableViewCell.reusableNIB(), forCellReuseIdentifier: PanggilanListTableViewCell.reusableIndentifer)
    ...
    fileprivate func addBarItem() {
        // more and search
        let moreButtonItem = UIBarButtonItem(barButtonSystemItem: .action, target: self, action: #selector(self.opengroupmenu(_:)))
...
extension PanggilanView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: PanggilanListTableViewCell.reusableIndentifer, for: indexPath) as! PanggilanListTableViewCell
        return cell
    }
